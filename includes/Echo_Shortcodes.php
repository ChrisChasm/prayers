...
class Echo_Shortcodes
{
	...
	{
		add_shortcode( 'echo_prayers', array( $this, 'prayers_shortcode' ) );
		add_shortcode( 'echo_prayers_form', array( $this, 'prayers_form_shortcode' ) );
		add_shortcode( 'echo_prayers_map', array( $this, 'prayers_map_shortcode' ) );
	}
