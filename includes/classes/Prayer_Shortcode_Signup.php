...
class Prayer_Shortcode_Signup
{
	...
	{
		add_shortcode( 'prayer_mailchimp_signup', array( __CLASS__, 'handle_shortcode' ) );
	...
	static function handle_shortcode( $atts ) 
	{
		...
		ob_start();
		$templates->get_template_part( 'content', 'prayers-mailchimp-signup' );
		return ob_get_clean();
	}
